      ...
      <div className="hero">
        ...
        <div className="search-bar">
          <input
            ...
            placeholder="Search by plant name or ailment..."
          />
      ...
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
          <div className="card" style={{ textAlign: 'center' }}>
            ...
            <h3>Browse Plants</h3>
            <p>Explore all documented medicinal plants</p>
            <br />
          ...
          <div className="card" style={{ textAlign: 'center' }}>
            ...
            <p>Upload audio from traditional healers</p>
            <br />
            <Link to="/upload"><button className="btn btn-orange">Upload</button></Link>
          </div>
          <div className="card" style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '40px' }}>🤖</div>
            <h3>Ask the Chatbot</h3>
            <p>Ask questions about herbal remedies</p>
            <br />
